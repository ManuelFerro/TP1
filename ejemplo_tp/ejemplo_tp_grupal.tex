...
\begin{proc}{trayectoriaDeLosFrutosIndividualesALargoPlazo}
	...
	\requiere{
		(\longitud[trayectorias] = \longitud[cooperan] = \longitud[apuestas] = \longitud[pagos] = \longitud[eventos]) \yLuego %chequeo si las listas trabajan el mismo grupo de individuos
			\paraTodo[unalinea]{i,j,k}{\ent}{
				((0 <= i,j < \longitud[pagos]) \yLuego (0 <= k < pagos[i])) \implicaLuego % "<=" se printea bien? preguntar
	...
	\asegura{
		...
		\paraTodo[unalinea]{i}{\ent}{
			(0 <= i < \longitud[eventos]) \implicaLuego (\longitud[trayectorias[i]] = \longitud[eventos[i]] + 1)
	...
	\pred{PagoApuestaCorrecto}{trayectorias, apuestas, pagos, eventos}{
		...
		\paraTodo[unalinea]{i,j}{\ent}{
			((0 <= i < \longitud[trayectorias]) \yLuego (1 <= j < \longitud[trayectorias[i]])) \implicaLuego %acomodo los índices
	...
	\pred{PagoPozoCorrecto}{trayectorias, cooperan}{
		...
		\paraTodo[unalinea]{i,j}{\ent}{ ((0 <= i < \longitud[trayectorias]) \yLuego (1 <= j < \longitud[trayectorias[i]])) \implicaLuego
	...
	\paraTodo[unalinea]{i}{\ent}{
		(0 <= i < \longitud[trayectorias]) \implicaLuego 
