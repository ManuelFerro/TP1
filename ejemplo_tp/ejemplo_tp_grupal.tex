...
\begin{proc}{trayectoriaDeLosFrutosIndividualesALargoPlazo}
	...
	\requiere{
		igualLongitud(trayectorias, cooperan, apuestas, pagos, eventos) \yLuego %chequeo si las listas trabajan el mismo grupo de individuos
...
\begin{proc}{individuoActualizaApuesta:}
	...
	\requiere{
		igualLongitud(recursos, cooperan, apuestas, pagos, eventos) \yLuego	
