...
\begin{proc}{trayectoriaDeLosFrutosIndividualesALargoPlazo}
	...
	\requiere{
		igualLongitud(trayectorias, apuestas, pagos, eventos) \yLuego %chequeo si las listas trabajan el mismo grupo de individuos

		mismosEventos(apuestas, pagos) \yLuego %chequeo si ambas refieren al mismo grupo de posibles eventos
	...
	\pred{igualLongitud}{trayectorias, cooperan, apuestas, pagos, eventos}
	{\longitud[trayectorias] = \longitud[cooperan] = \longitud[apuestas] = \longitud[pagos] = \longitud[eventos]
	}
	\pred{mismosEventos}{apuestas, pagos}
	{\paraTodo[unalinea]{i}{\ent}{
...
\begin{proc}{individuoActualizaApuesta:}
	...
	\requiere{0 $\leq$ individuo $<$ \longitud[apuestas]}
	\asegura{expresionBooleana2}
	\aux{auxiliar1}{parametros}{tipoRes}{expresion}
	\pred{pred1}{parametros}{expresion} 
\end{proc}
